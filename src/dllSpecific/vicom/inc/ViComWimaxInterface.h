// ViComWiMaxInterface.h
#pragma once
#include "ViComWimaxInterfaceData.h"
#include "ViComWimaxErrors.h"
...
public:
   ...
   */   
   virtual bool SetFrequencyTable( CViComError&                                      rViComError,
                                   const SChannelSettings& rFrequencySettings ) = 0;
   virtual void SetFrequencyTable( const SChannelSettings& rFrequencySettings ) = 0;
   //!< @throw CViComError @see SetFrequencyTable( CViComError&, const SChannelSettings& )
   ...
   */
   virtual const SMeasResult* GetResult( CViComError& rViComError,
...
public: // static functions
   //! \internal
   static const char*      GetName() { return "WIMAX"; }
   static Technology::Type GetType() { return Technology::WIMAX; }

protected:
   //! \internal
   CViComWimaxInterface(){}
   //! \internal
   virtual ~CViComWimaxInterface(){}

private:
   //! \internal
   CViComWimaxInterface(const CViComWimaxInterface&);
   void operator=(const CViComWimaxInterface&);
};

typedef CViComWimaxInterface     INTERFACE_TYPE;
