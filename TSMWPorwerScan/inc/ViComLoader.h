...
public:
   ...
   {
      m_pfCreateInterface  = reinterpret_cast<typename ftCreateInterface*> ( ::GetProcAddress( m_loaderManager.get(), "Create"  ) );
      m_pfDestroyInterface = reinterpret_cast<typename ftDestroyInterface*>( ::GetProcAddress( m_loaderManager.get(), "Destroy" ) );
   }
